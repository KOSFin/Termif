...
export function buildAppCommands(ctx: AppCommandContext): PaletteCommand[] {
  return [
    ...
    { id: "setting.window_opacity", title: "Setting: App Opacity", category: "Settings", action: () => ctx.openSettingsAt("appearance", "App Opacity") },
    { id: "setting.terminal_background_image", title: "Setting: App Background Image", category: "Settings", action: () => ctx.openSettingsAt("appearance", "App Background Image") },
    { id: "setting.terminal_background_dim", title: "Setting: App Background Dimming", category: "Settings", action: () => ctx.openSettingsAt("appearance", "App Background Dimming") },
